...
)
{
    ...
    *------------------------------------------------------------------*/
    ...
    for (i = 1; i < nbTracks; i++)
    {
        ...
        alp0 = ((Word32) rr[i0][i0] + (Word32) rr[i1][i1]) << 12;
            ...
            ps1 = dn[j];
            {
                ...
                __asm__ volatile (
                 ...
                 "1:                                                                  \n\t"
                    ...
                    "sll           %[temp3],   %[i3],                  1              \n\t"
                    "addu          %[ps2],     %[ps1],                 %[temp1]       \n\t"
                    "lhx           %[temp3],   %[temp3](%[p_temp2])                   \n\t"
                    "mulq_s.ph     %[sq2],     %[ps2],                 %[ps2]         \n\t"
                    "lh            %[temp4],   2(%[p_temp1])                          \n\t"
                    "addu          %[alp2],    %[alp1],                %[temp3]       \n\t"
                    "sra           %[alp2],    %[alp2],                2              \n\t"
                    "addqh.w       %[alp2],    %[alp2],                %[temp4]       \n\t"
                    "addu          %[i3],      %[i3],                  %[step]        \n\t"
                    "mul           %[temp2],   %[alp],                 %[sq2]         \n\t"
                    "mul           %[temp5],   %[sq],                  %[alp2]        \n\t"
                    "sll           %[temp3],   %[i3],                  1              \n\t"
                 ...
                 "33:                                                                 \n\t"
                    ...
                    ".set pop                                                         \n\t"
                    :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2),[ alp2] "=&r" (alp2),
                     [p_temp1] "+r" (p_temp1), [sq] "+r" (sq), [ps] "+r" (ps), [alp] "+r" (alp),
                     [ia] "+r" (ia), [ib] "+r" (ib),
                     [temp1] "=&r" (temp1), [temp3] "=&r" (temp3), [temp2] "=&r" (temp2),
                     [temp4] "=&r" (temp4), [temp5] "=&r" (temp5)
                    :[ps1] "r" (ps1), [i3] "r" (i3), [p_temp2] "r" (p_temp2), [step] "r" (step),
                     [alp1] "r" (alp1), [j] "r" (j), [ipos] "r" (ipos)
                    : "memory", "hi", "lo"
                );
            }
...
#elif (MIPS32_R2_LE)
            {
                ...
                __asm__ volatile (
                 ...
                 "33:                                                                 \n\t"
                    ...
                    :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2),[alp2] "=&r" (alp2),
                     [p_temp1] "+r" (p_temp1) ,[sq] "+r" (sq),[ps] "+r" (ps),[alp] "+r" (alp),
                     [ia] "+r" (ia),[ib] "+r" (ib), [ps1] "=&r" (ps1),
                     [temp1] "=&r" (temp1),[temp3] "=&r" (temp3),[temp2] "=&r" (temp2),
                     [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
                    :[i3] "r" (i3),[p_temp2] "r" (p_temp2) ,[step] "r" (step),
                     [alp1] "r" (alp1),[j] "r" (j),[ipos] "r" (ipos), [dn] "r" (dn)
                    :"hi", "lo", "memory"
                );
            }
#endif
        ...
        *----------------------------------------------------------------*/
        ...
        for (j = ipos[4]; j < L_CODE; j += step)
        {
            ...
            alp1 += ((Word32)  (p_temp2[i0]) +(Word32) (p_temp2[i1]) + (Word32) (p_temp2[i2])
                    + (Word32) (p_temp2[i3])) << 12;
            ...
            ps1 =  dn[j];
            {
                ...
                __asm__ volatile (
                 ...
                 "31:                                                                 \n\t"
                    ...
                    :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2), [alp2] "=&r" (alp2),
                     [p_temp1] "+r" (p_temp1), [sq] "+r" (sq), [ps] "+r" (ps), [alp] "+r" (alp),
                     [ia] "+r" (ia), [ib] "+r" (ib), [i5] "=&r" (i5),
                     [temp1] "=&r" (temp1), [temp3] "=&r" (temp3), [temp2] "=&r" (temp2),
                     [temp4] "=&r" (temp4), [temp5] "=&r" (temp5)
                    :[ps1] "r" (ps1), [p_temp2] "r" (p_temp2) ,
                     [alp1] "r" (alp1), [j] "r" (j), [ipos] "r" (ipos), [step] "r" (step)
                    :"memory", "hi", "lo"
                );
            }
#elif (MIPS_DSP_R1_LE)/*(MIPS_DSP_R1_LE)*/
...
#elif (MIPS32_R2_LE)
            {
                ...
                __asm__ volatile (
                 ...
                 "333:                                                                \n\t"
                    ...
                    :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2),[alp2] "=&r" (alp2),
                     [p_temp1] "+r" (p_temp1) ,[sq] "+r" (sq),[ps] "+r" (ps),[alp] "+r" (alp),
                     [ia] "+r" (ia),[ib] "+r" (ib),[i5] "=&r" (i5), [ps1] "=&r" (ps1),
                     [temp1] "=&r" (temp1),[temp3] "=&r" (temp3),[temp2] "=&r" (temp2),
                     [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
                    :[p_temp2] "r" (p_temp2), [dn] "r" (dn),
                     [alp1] "r" (alp1),[j] "r" (j),[ipos] "r" (ipos) ,[step] "r" (step)
                    :"hi", "lo", "memory"
                );
            }
        ...
        *----------------------------------------------------------------*/
        ...
        for (j = ipos[6]; j < L_CODE; j += step)
        {
            ...
            alp1 += ((Word32) (p_temp2[i0]) + (Word32) (p_temp2[i1]) + (Word32) (p_temp2[i2]) +
                     (Word32) (p_temp2[i3]) + (Word32) (p_temp2[i4]) + (Word32) (p_temp2[i5]))  << 11;
...
#elif (MIPS32_R2_LE)
            {
                ...
                __asm__ volatile (
                 ...
                 "333:                                                                \n\t"
                    ...
                    :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2),[alp2] "=&r" (alp2),
                     [p_temp1] "+r" (p_temp1) ,[sq] "+r" (sq),[ps] "+r" (ps),[alp] "+r" (alp),
                     [ia] "+r" (ia),[ib] "+r" (ib),[i7] "=&r" (i7), [ps1] "=&r" (ps1),
                     [temp1] "=&r" (temp1),[temp3] "=&r" (temp3),[temp2] "=&r" (temp2),
                     [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
                    :[p_temp2] "r" (p_temp2), [dn] "r" (dn),
                     [alp1] "r" (alp1),[j] "r" (j),[ipos] "r" (ipos),[step] "r" (step)
        ...
        if (gsmefrFlag != 0)
        {
            ...
            *----------------------------------------------------------------*/
            ...
            for (j = ipos[8]; j < L_CODE; j += step)
            {
                ...
                alp1 += ((Word32) rr[i0][j] + (Word32) rr[i1][j] + (Word32) rr[i2][j] +
                        (Word32) rr[i3][j] + (Word32) rr[i4][j] + (Word32) rr[i5][j] +
                        (Word32) rr[i6][j] + (Word32) rr[i7][j]) << 10;
                ...
                ps1 = dn[j];
                {
                    ...
                    __asm__ volatile (
                     ...
                     "333:                                                                \n\t"
                        ...
                        :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2), [alp2] "=&r" (alp2),
                         [p_temp1] "+r" (p_temp1), [sq] "+r" (sq), [ps] "+r" (ps), [alp] "+r" (alp),
                         [ia] "+r" (ia), [ib] "+r" (ib), [i9] "=&r" (i9),
                         [temp1] "=&r" (temp1), [temp3] "=&r" (temp3), [temp2] "=&r" (temp2),
                         [temp4] "=&r" (temp4), [temp5] "=&r" (temp5)
                        :[ps1] "r" (ps1), [p_temp2] "r" (p_temp2), [alp1] "r" (alp1),
                         [j] "r" (j), [ipos] "r" (ipos), [step] "r" (step)
                        :"memory", "hi", "lo"
                    );
                }
#elif (MIPS_DSP_R1_LE)/*(MIPS_DSP_R1_LE)*/
...
#elif (MIPS32_R2_LE)
                {
                    ...
                    __asm__ volatile (
                     ...
                     "333:                                                                \n\t"
                        ...
                        :[ps2] "=&r" (ps2), [sq2] "=&r" (sq2),[alp2] "=&r" (alp2),
                         [p_temp1] "+r" (p_temp1) ,[sq] "+r" (sq),[ps] "+r" (ps),[alp] "+r" (alp),
                         [ia] "+r" (ia),[ib] "+r" (ib),[i9] "=&r" (i9), [ps1] "=&r" (ps1),
                         [temp1] "=&r" (temp1),[temp3] "=&r" (temp3),[temp2] "=&r" (temp2),
                         [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
                        :[p_temp2] "r" (p_temp2) ,[dn] "r" (dn),
                         [alp1] "r" (alp1),[j] "r" (j),[ipos] "r" (ipos),[step] "r" (step)
