...
#define NB_PULSE  4
    ...
    */
    ...
    int pos_2[32] = { 0,1,2,3,  3,0,1,2, 2,3,0,1, 1,2,3,0,
                      0,1,2,4,  4,0,1,2, 2,4,0,1, 1,2,4,0
                    };
                    ...
                    if (dn2[i0] >= 0)
                    {
                         ...
                         *----------------------------------------------------------------*/
                         ...
                         "12:                                                              \n\t"
                            ...
                            "mulq_s.ph     %[sq1],     %[ps1],               %[ps1]        \n\t"
                            "addu          %[alp1],    %[alp0],              %[temp5]      \n\t"
                            "addu          %[temp4],   %[temp4],             %[temp3]      \n\t"
                            "sll           %[temp4],   %[temp4],             13            \n\t"
                            "addu          %[alp1],    %[alp1],              %[temp4]      \n\t"
                            "shra_r.w      %[alp_16],  %[alp1],              16            \n\t"
                            "mul           %[temp3],   %[alp],               %[sq1]        \n\t"
                            "mul           %[temp4],   %[sq],                %[alp_16]     \n\t"
                            "addiu         %[temp6],   %[temp6],             410           \n\t"
                            "addiu         %[i3],      %[i3],                10            \n\t"
                            "lh            %[temp5],   0(%[temp6])                         \n\t"
                            "lhx           %[alp1],    %[i3](%[dn])                        \n\t"
                            "lhx           %[temp1],   %[i3](%[rri1])                      \n\t"
                         ...
                         "35:                                                              \n\t"
                            ...
                            :[temp1] "=&r" (temp1), [ps1] "=&r" (ps1),
                             ...
                             [i1] "=&r" (i1),[i2] "=&r" (i2),[rr_i2] "=&r" (rr_i2),[i3] "=&r" (i3)
                         ...
                         *----------------------------------------------------------------*/
                         ...
                         "12:                                                               \n\t"
                            ...
                            "sll           %[temp4],   %[temp4],             13             \n\t"
                            "addu          %[alp1],    %[alp1],              %[temp4]       \n\t"
                            "addiu         %[temp3],   %[alp1],              0x7fff         \n\t"
                            "addiu         %[temp3],   %[temp3],             0x1            \n\t"
                            "sra           %[alp_16],  %[temp3],             16             \n\t"
                            "sra           %[sq1],     %[sq1],               15             \n\t"
                            "mul           %[temp3],   %[alp],               %[sq1]         \n\t"
                            "mul           %[temp4],   %[sq],                %[alp_16]      \n\t"
