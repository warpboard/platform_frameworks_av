...
)
{
    ...
    Word32 temp_coeff_55, temp_coeff_66, temp_coeff_77, temp_coeff_88, temp_coeff_99;
    {
        ...
        __asm__ volatile (
            ...
            "lh           %[temp_coeff_55],   10(%[coeff_lo])               \n\t"
            "lh           %[temp_coeff_66],   12(%[coeff_lo])               \n\t"
            "lh           %[temp_coeff_77],   14(%[coeff_lo])               \n\t"
            "lh           %[temp_coeff_88],   16(%[coeff_lo])               \n\t"
            "lh           %[temp_coeff_99],   18(%[coeff_lo])               \n\t"
            "sll          %[temp_coeff_55],   %[temp_coeff_55],   1         \n\t"
            "sll          %[temp_coeff_66],   %[temp_coeff_66],   1         \n\t"
            "sll          %[temp_coeff_77],   %[temp_coeff_77],   1         \n\t"
            "sll          %[temp_coeff_88],   %[temp_coeff_88],   1         \n\t"
            "sll          %[temp_coeff_99],   %[temp_coeff_99],   1         \n\t"
            "lh           %[temp1],           10(%[coeff])                  \n\t"
            "lh           %[temp2],           12(%[coeff])                  \n\t"
            "lh           %[temp3],           14(%[coeff])                  \n\t"
            "lh           %[temp4],           16(%[coeff])                  \n\t"
            "lh           %[temp5],           18(%[coeff])                  \n\t"
            "ins          %[temp_coeff_55],   %[temp1],           16, 16    \n\t"
            "ins          %[temp_coeff_66],   %[temp2],           16, 16    \n\t"
            "ins          %[temp_coeff_77],   %[temp3],           16, 16    \n\t"
            "ins          %[temp_coeff_88],   %[temp4],           16, 16    \n\t"
            "ins          %[temp_coeff_99],   %[temp5],           16, 16    \n\t"

            :[temp_coeff_00] "=&r" (temp_coeff_00), [temp_coeff_11] "=&r" (temp_coeff_11),
             [temp_coeff_22] "=&r" (temp_coeff_22), [temp_coeff_33] "=&r" (temp_coeff_33),
             [temp_coeff_44] "=&r" (temp_coeff_44), [temp_coeff_99] "=&r" (temp_coeff_99),
             [temp_coeff_55] "=&r" (temp_coeff_55), [temp_coeff_66] "=&r" (temp_coeff_66),
             [temp_coeff_77] "=&r" (temp_coeff_77), [temp_coeff_88] "=&r" (temp_coeff_88),
    ...
    for (i = 0; i < MR475_VQ_SIZE; i++)
    {
        ...
        Word32 temp1, temp2, temp3, temp4, temp5;
        __asm__ volatile (
            "mulq_s.ph       %[g_code],    %[sf0_gcode0],    %[g_code]      \n\t"
            ...
            :[sf0_gcode0] "r" (sf0_gcode0),[temp_coeff_00] "r" (temp_coeff_00),
        ...
        if ((tmp <= 0) && (g_pitch <= gp_limit))
        {
            Word32 temp1, temp2, temp3, temp4, temp5;
            __asm__ volatile (
                "mulq_s.ph       %[g_code],    %[sf1_gcode0],    %[g_code]      \n\t"
                "sll             %[temp2],     %[g_pitch],       16             \n\t"
                "mulq_s.ph       %[g2_pitch],  %[g_pitch],       %[g_pitch]     \n\t"
                "mulq_s.ph       %[g2_code],   %[g_code],        %[g_code]      \n\t"
                "mulq_s.ph       %[g_pit_cod], %[g_code],        %[g_pitch]     \n\t"
                ...
                "sll             %[temp3],     %[g2_code],       16             \n\t"
                "sll             %[temp5],     %[g_pit_cod],     16             \n\t"
                "mulq_s.w        %[temp1],     %[temp_coeff_55], %[temp1]       \n\t"//L_tmp = Mpy_32_16(coeff[0], coeff_lo[0], g2_pitch, pOverflow);
                "mulq_s.w        %[temp2],     %[temp_coeff_66], %[temp2]       \n\t"
                "mulq_s.w        %[temp3],     %[temp_coeff_77], %[temp3]       \n\t"
                "mulq_s.w        %[temp4],     %[temp_coeff_88], %[temp4]       \n\t"
                "mulq_s.w        %[temp5],     %[temp_coeff_99], %[temp5]       \n\t"
                "and             %[temp1],     %[temp1],         %[temp_const]  \n\t"
                "and             %[temp2],     %[temp2],         %[temp_const]  \n\t"
                "and             %[temp3],     %[temp3],         %[temp_const]  \n\t"
                "and             %[temp4],     %[temp4],         %[temp_const]  \n\t"
                ...
                :[g_code] "+r" (g_code), [g_pitch] "+r" (g_pitch),
                 ...
                 [temp1] "=&r" (temp1), [temp2] "=&r" (temp2),
                 [temp3] "=&r" (temp3), [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
                :[sf1_gcode0] "r" (sf1_gcode0),[temp_coeff_55] "r" (temp_coeff_55),
                 [temp_coeff_66] "r" (temp_coeff_66), [temp_coeff_77] "r" (temp_coeff_77),
                 [temp_coeff_88] "r" (temp_coeff_88), [temp_coeff_99] "r" (temp_coeff_99),
                 [temp_const] "r" (temp_const)
                :"memory", "hi", "lo"
            );
    ...
    for (i = 0; i < MR475_VQ_SIZE; i++)
    {
        ...
        Word32 temp1, temp2, temp3, temp4, temp5;
        __asm__ volatile (
            "muleq_s.w.phr   %[g_code],    %[sf0_gcode0],    %[g_code]        \n\t"
            "sll             %[temp2],     %[g_pitch],       16               \n\t"
            ...
            :[g_code] "+r" (g_code), [L_tmp] "=&r" (L_tmp), [g2_pitch] "=&r" (g2_pitch),
             [g_pit_cod] "=&r" (g_pit_cod), [g2_code] "=&r" (g2_code),
             [temp1] "=&r" (temp1), [temp2] "=&r" (temp2), [temp3] "=&r" (temp3),
             [temp4] "=&r" (temp4),[temp5] "=&r" (temp5)
            :[sf0_gcode0] "r" (sf0_gcode0), [temp_coeff_00] "r" (temp_coeff_00),
             [temp_coeff_11] "r" (temp_coeff_11), [temp_coeff_22] "r" (temp_coeff_22),
        ...
        if ((tmp <= 0) && (g_pitch <= gp_limit))
        {
            Word32 temp1, temp2, temp3, temp4, temp5;
            __asm__ volatile (
                "muleq_s.w.phr   %[g_code],    %[sf1_gcode0],    %[g_code]        \n\t"
                "sll             %[temp2],     %[g_pitch],       16               \n\t"
                "muleq_s.w.phl   %[g2_pitch],  %[temp2],         %[temp2]         \n\t"
                "muleq_s.w.phl   %[g2_code],   %[g_code],        %[g_code]        \n\t"
                "muleq_s.w.phl   %[g_pit_cod], %[g_code],        %[temp2]         \n\t"
                ...
                "and             %[temp3],     %[g2_code],       %[temp_const_1]  \n\t"
                "and             %[temp5],     %[g_pit_cod],     %[temp_const_1]  \n\t"
                "mult            $ac0,         %[temp_coeff_55], %[temp1]         \n\t"
                "mult            $ac1,         %[temp_coeff_66], %[temp2]         \n\t"
                "mult            $ac2,         %[temp_coeff_77], %[temp3]         \n\t"
                "mult            $ac3,         %[temp_coeff_88], %[temp4]         \n\t"
                "extr.w          %[temp1],     $ac0,             31               \n\t"
                "extr.w          %[temp2],     $ac1,             31               \n\t"
                "extr.w          %[temp3],     $ac2,             31               \n\t"
                "extr.w          %[temp4],     $ac3,             31               \n\t"
                "mult            $ac0,         %[temp_coeff_99], %[temp5]         \n\t"
                "extr.w          %[temp5],     $ac0,             31               \n\t"
                "and             %[temp1],     %[temp1],         %[temp_const]    \n\t"
                "and             %[temp2],     %[temp2],         %[temp_const]    \n\t"
                "and             %[temp3],     %[temp3],         %[temp_const]    \n\t"
    ...
    for (i = 0; i < MR475_VQ_SIZE; i++)
    {
        ...
        L_tmp = L_add(temp1, temp2, pOverflow);
        L_tmp = L_add(L_tmp, temp3, pOverflow);
        L_tmp = L_add(L_tmp, temp4, pOverflow);
        L_tmp = L_add(L_tmp, temp5, pOverflow);
        ...
        if ((tmp <= 0) && (g_pitch <= gp_limit))
        {
            ...
            __asm__ volatile (
                ...
                "and         %[temp3],         %[g2_code],       %[temp_const_1]  \n\t"
                "and         %[temp5],         %[g_pit_cod],     %[temp_const_1]  \n\t"
                "mult        %[temp_coeff_55], %[temp1]                           \n\t"
                "mfhi        %[temp1]                                             \n\t"
                "mult        %[temp_coeff_66], %[temp2]                           \n\t"
                "mfhi        %[temp2]                                             \n\t"
                "mult        %[temp_coeff_77], %[temp3]                           \n\t"
                "mfhi        %[temp3]                                             \n\t"
                "mult        %[temp_coeff_88], %[temp4]                           \n\t"
                "mfhi        %[temp4]                                             \n\t"
                "mult        %[temp_coeff_99], %[temp5]                           \n\t"
                "mfhi        %[temp5]                                             \n\t"
                "sll         %[temp1],         %[temp1],         1                \n\t"
                "sll         %[temp2],         %[temp2],         1                \n\t"
                "sll         %[temp3],         %[temp3],         1                \n\t"
            ...
            L_tmp = L_add(L_tmp, temp1, pOverflow);
            L_tmp = L_add(L_tmp, temp2, pOverflow);
            L_tmp = L_add(L_tmp, temp3, pOverflow);
            L_tmp = L_add(L_tmp, temp4, pOverflow);
            L_tmp = L_add(L_tmp, temp5, pOverflow);
