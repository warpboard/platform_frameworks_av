    ...
    if(chromaPartWidth>4){
        for (comp = 0; comp <= 1; comp++)
        {
            ...
            for (y = (chromaPartHeight >> 1); y; y--)
            {
                ...
                __asm__ volatile (
                    "addu        %[tmp1],      %[ptrA],         %[tmp_ptrA] \n\t"
                    "addu        %[tmp2],      %[tmp1],         %[width]    \n\t"
                    "addu        %[tmp3],      %[tmp2],         %[width]    \n\t"
                    "addu        %[tmp4],      %[cbr],          %[tmp_cbr]  \n\t"
    ...
    for (i = (partHeight >> 2); i; i--)
    {
        ...
        for (j = partWidth; j; j-=4)
        {
            ...
            __asm__ volatile (
                ...
                "preceu.ph.qbr    %[tmp_R_2],   %[tmp_L_2]                       \n\t"
                "preceu.ph.qbl    %[tmp_L_2],   %[tmp_L_2]                       \n\t"
                "preceu.ph.qbr    %[tmp_R_3],   %[tmp_L_3]                       \n\t"
                "preceu.ph.qbl    %[tmp_L_3],   %[tmp_L_3]                       \n\t"
                ...
                "mul.ph           %[tmp3],      %[tmp3],        %[tmp_const_20]  \n\t"
                "sw               %[tmp2],      32(%[mb])                        \n\t"
                "preceu.ph.qbr    %[tmp_R_1],   %[tmp_L_1]                       \n\t"
                "preceu.ph.qbl    %[tmp_L_1],   %[tmp_L_1]                       \n\t"
                "subq.ph          %[tmp6],      %[tmp5],        %[tmp6]          \n\t"
                "subq.ph          %[tmp4],      %[tmp3],        %[tmp4]          \n\t"
                ...
                "shll_s.ph        %[tmp2],      %[tmp2],        7                \n\t"
                "shll_s.ph        %[tmp1],      %[tmp1],        7                \n\t"
                "ulw              %[tmp_L_6],   0(%[temp_ptrC])                  \n\t"
                "addq.ph          %[tmp6],      %[tmp_R_1],     %[tmp_R_4]       \n\t"
                "addq.ph          %[tmp5],      %[tmp_R_2],     %[tmp_R_3]       \n\t"
                "precrqu_s.qb.ph  %[temp_ptrC], %[tmp1],        %[tmp2]          \n\t"
                ...
                "mul.ph           %[tmp4],      %[tmp4],        %[tmp_const_5]   \n\t"
                "mul.ph           %[tmp3],      %[tmp3],        %[tmp_const_20]  \n\t"
                "preceu.ph.qbr    %[tmp_R_6],   %[tmp_L_6]                       \n\t"
                "preceu.ph.qbl    %[tmp_L_6],   %[tmp_L_6]                       \n\t"
    ...
    for (y = partHeight; y; y--)
    {
        ...
        for (x = (partWidth >> 2); x; x--)
        {
            ...
            __asm__ volatile (
                ...
                "mul.ph           %[tmp3],     %[tmp3],     %[tmp_const_20] \n\t"
                "preceu.ph.qbl    %[tmp_2_3],  %[tmp_2_3]                   \n\t"
                "addq.ph          %[tmp_5_4],  %[tmp_5_4],  %[tmp_0_1]      \n\t"
                "addq.ph          %[tmp_3_2],  %[tmp_3_2],  %[tmp_2_3]      \n\t"
                "subq.ph          %[tmp6],     %[tmp4],     %[tmp6]         \n\t"
                "subq.ph          %[tmp5],     %[tmp3],     %[tmp5]         \n\t"
                "addq.ph          %[tmp4],     %[tmp_5_4],  %[tmp6]         \n\t"
                "addq.ph          %[tmp3],     %[tmp_3_2],  %[tmp5]         \n\t"
                       ...
                       2 for pixel p, 3 for pixel r */
{
    ...
    ptrV = ref + width + 2 + (horVerOffset & 0x1) + 5*width;


    i32 tmp_5, tmp_6, tmp_7, tmp_8;
    i32 tmp_9, tmp_10,tmp_11, tmp_12, tmp_13, tmp_14;
    i32 tmp_17, tmp_15, tmp_16;
    i32 tmp_1, tmp_2, tmp_3, tmp_4;
    i32 temp_partWidth,temp_partHeight;
    u8 *tmp_pok[2];
    tmp_pok[0] = ptrJ;
    tmp_pok[1] = ptrV;
    ...
    __asm__ volatile (
        ...
        "repl.ph          %[tmp_const_5],   5                               \n\t"
        "repl.ph          %[tmp_const_20],  20                              \n\t"
        "move             %[tmp_15],        %[partHeight]                   \n\t"
      "1:                                                                   \n\t"
        "sra              %[temp_partWidth],%[partWidth], 2                 \n\t"
        "ulw              %[tmp_6],         -5(%[tmp_17])                   \n\t"
        "ulw              %[tmp_8],         -4(%[tmp_17])                   \n\t"
        "addu             %[tmp_11],        %[tmp_17],    %[width]          \n\t"
        /* prefetch for store for the whole loop that follows */
        "pref             1,                32(%[mb])                       \n\t"
        /* prefetch for load for the whole loop that follows */
        "pref             0,                0(%[tmp_11])                    \n\t"
        /* to make sure all the data is prefetched */
        "pref             0,                32(%[tmp_11])                   \n\t"
        "preceu.ph.qbr    %[tmp_5],         %[tmp_6]                        \n\t"
        "preceu.ph.qbl    %[tmp_6],         %[tmp_6]                        \n\t"
        "preceu.ph.qbr    %[tmp_7],         %[tmp_8]                        \n\t"
        "preceu.ph.qbl    %[tmp_8],         %[tmp_8]                        \n\t"
      "2:                                                                   \n\t"
        "ulw              %[tmp_11],        -1(%[tmp_17])                   \n\t"
        "ulw              %[tmp_4],         0(%[tmp_17])                    \n\t"
        "addiu            %[mb],            %[mb],        4                 \n\t"
        "preceu.ph.qbr    %[tmp_1],         %[tmp_11]                       \n\t"
        "preceu.ph.qbl    %[tmp_2],         %[tmp_11]                       \n\t"
        "preceu.ph.qbr    %[tmp_3],         %[tmp_4]                        \n\t"
        "addq.ph          %[tmp_9],         %[tmp_7],     %[tmp_1]          \n\t"
        "addq.ph          %[tmp_10],        %[tmp_8],     %[tmp_2]          \n\t"
        "addq.ph          %[tmp_11],        %[tmp_6],     %[tmp_8]          \n\t"
        "addq.ph          %[tmp_12],        %[tmp_1],     %[tmp_3]          \n\t"
        "mul.ph           %[tmp_9],         %[tmp_9],     %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_10],        %[tmp_10],    %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_11],        %[tmp_11],    %[tmp_const_20]   \n\t"
        "mul.ph           %[tmp_12],        %[tmp_12],    %[tmp_const_20]   \n\t"
        "preceu.ph.qbl    %[tmp_4],         %[tmp_4]                        \n\t"
        "addq.ph          %[tmp_13],        %[tmp_5],     %[tmp_3]          \n\t"
        "addq.ph          %[tmp_14],        %[tmp_6],     %[tmp_4]          \n\t"
        "subq.ph          %[tmp_9],         %[tmp_11],    %[tmp_9]          \n\t"
        "subq.ph          %[tmp_10],        %[tmp_12],    %[tmp_10]         \n\t"
        "addq.ph          %[tmp_11],        %[tmp_13],    %[tmp_9]          \n\t"
        "addq.ph          %[tmp_12],        %[tmp_14],    %[tmp_10]         \n\t"
        "shra_r.ph        %[tmp_11],        %[tmp_11],    5                 \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    5                 \n\t"
        "addiu            %[tmp_17],        %[tmp_17],    4                 \n\t"
        "shll_s.ph        %[tmp_11],        %[tmp_11],    7                 \n\t"
        "shll_s.ph        %[tmp_12],        %[tmp_12],    7                 \n\t"
        "move             %[tmp_5],         %[tmp_1]                        \n\t"
        "precrqu_s.qb.ph  %[tmp_11],        %[tmp_11],    %[tmp_11]         \n\t"
        "precrqu_s.qb.ph  %[tmp_12],        %[tmp_12],    %[tmp_12]         \n\t"
        "move             %[tmp_7],         %[tmp_3]                        \n\t"
        "preceu.ph.qbr    %[tmp_11],        %[tmp_11]                       \n\t"
        "preceu.ph.qbr    %[tmp_12],        %[tmp_12]                       \n\t"
        "move             %[tmp_6],         %[tmp_2]                        \n\t"
        "precr.qb.ph      %[tmp_9],         %[tmp_12],    %[tmp_11]         \n\t"
        "addiu            %[temp_partWidth],%[temp_partWidth],    -1        \n\t"
        "sw               %[tmp_9],         -4(%[mb])                       \n\t"
        "bnez             %[temp_partWidth],2b                              \n\t"
        " move            %[tmp_8],         %[tmp_4]                        \n\t"
        "addu             %[tmp_17],        %[tmp_17],    %[width]          \n\t"
        "addi             %[mb],            %[mb],        16                \n\t"
        "subu             %[tmp_17],        %[tmp_17],    %[partWidth]      \n\t"
        "addiu            %[tmp_15],        %[tmp_15],    -1                \n\t"
        "bnez             %[tmp_15],        1b                              \n\t"
        " subu            %[mb],            %[mb],        %[partWidth]      \n\t"
        "sll              %[tmp_12],        %[partHeight],4                 \n\t"
        "subu             %[mb],            %[mb],        %[tmp_12]         \n\t"
        "lw               %[tmp_pok],       4(%[tmp_pok])                   \n\t"
        "sra              %[partHeight],    %[partHeight],2                 \n\t"
      "3:                                                                   \n\t"
        "sll              %[tmp_12],        %[width],     2                 \n\t"
        "addu             %[tmp_12],        %[tmp_pok],   %[tmp_12]         \n\t"
        "addu             %[tmp_11],        %[tmp_12],    %[width]          \n\t"
        "addu             %[tmp_10],        %[tmp_11],    %[width]          \n\t"
        "addu             %[tmp_9],         %[tmp_10],    %[width]          \n\t"
        /* prefetch for store for the whole loop that follows */
        "pref             0,                32(%[mb])                       \n\t"
        /* prefetch for load retained for the whole   next loop that follows */
        "pref             0,                0(%[tmp_12])                    \n\t"
        "pref             0,                0(%[tmp_11])                    \n\t"
        "pref             0,                0(%[tmp_10])                    \n\t"
        "pref             0,                0(%[tmp_9])                     \n\t"
        "move             %[temp_partWidth],%[partWidth]                    \n\t"
      "4:                                                                   \n\t"
        "sll              %[tmp_12],        %[width],     1                 \n\t"
        "subu             %[tmp_11],        %[tmp_pok],   %[tmp_12]         \n\t"
        "subu             %[tmp_10],        %[tmp_pok],   %[width]          \n\t"
        "addu             %[tmp_14],        %[tmp_pok],   %[width]          \n\t"
        "ulw              %[tmp_4],         0(%[tmp_11])                    \n\t"
        "ulw              %[tmp_10],        0(%[tmp_10])                    \n\t"
        "addu             %[tmp_12],        %[tmp_pok],   %[tmp_12]         \n\t"
        "ulw              %[tmp_14],        0(%[tmp_14])                    \n\t"
        "preceu.ph.qbr    %[tmp_1],         %[tmp_4]                        \n\t"
        "preceu.ph.qbl    %[tmp_7],         %[tmp_4]                        \n\t"
        "preceu.ph.qbr    %[tmp_3],         %[tmp_10]                       \n\t"
        "preceu.ph.qbl    %[tmp_13],        %[tmp_10]                       \n\t"
        "ulw              %[tmp_12],        0(%[tmp_12])                    \n\t"
        "ulw              %[tmp_10],        0(%[tmp_pok])                   \n\t"
        "subu             %[tmp_pok],       %[tmp_11],    %[width]          \n\t"
        "preceu.ph.qbr    %[tmp_2],         %[tmp_14]                       \n\t"
        "preceu.ph.qbl    %[tmp_8],         %[tmp_14]                       \n\t"
        "preceu.ph.qbr    %[tmp_4],         %[tmp_10]                       \n\t"
        "preceu.ph.qbl    %[tmp_14],        %[tmp_10]                       \n\t"
        "ulw              %[tmp_11],        0(%[tmp_pok])                   \n\t"
        "addq.ph          %[tmp_9],         %[tmp_1],     %[tmp_2]          \n\t"
        "addq.ph          %[tmp_10],        %[tmp_3],     %[tmp_4]          \n\t"
        "mul.ph           %[tmp_9],         %[tmp_9],     %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_10],        %[tmp_10],    %[tmp_const_20]   \n\t"
        "preceu.ph.qbr    %[tmp_5],         %[tmp_11]                       \n\t"
        "preceu.ph.qbl    %[tmp_15],        %[tmp_11]                       \n\t"
        "preceu.ph.qbr    %[tmp_6],         %[tmp_12]                       \n\t"
        "preceu.ph.qbl    %[tmp_16],        %[tmp_12]                       \n\t"
        "addq.ph          %[tmp_11],        %[tmp_7],     %[tmp_8]          \n\t"
        "addq.ph          %[tmp_12],        %[tmp_13],    %[tmp_14]         \n\t"
        "mul.ph           %[tmp_11],        %[tmp_11],    %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_12],        %[tmp_12],    %[tmp_const_20]   \n\t"
        "subq.ph          %[tmp_9],         %[tmp_10],    %[tmp_9]          \n\t"
        "addq.ph          %[tmp_10],        %[tmp_16],    %[tmp_15]         \n\t"
        "addq.ph          %[tmp_6],         %[tmp_6],     %[tmp_5]          \n\t"
        "lw               %[tmp_16],        48(%[mb])                       \n\t"
        "subq.ph          %[tmp_11],        %[tmp_12],    %[tmp_11]         \n\t"
        "addq.ph          %[tmp_10],        %[tmp_10],    %[tmp_11]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_6],     %[tmp_9]          \n\t"
        "preceu.ph.qbr    %[tmp_6],         %[tmp_16]                       \n\t"
        "preceu.ph.qbl    %[tmp_16],        %[tmp_16]                       \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    5                 \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    5                 \n\t"
        "subu             %[tmp_pok],       %[tmp_pok],   %[width]          \n\t"
        "shll_s.ph        %[tmp_10],        %[tmp_10],    7                 \n\t"
        "shll_s.ph        %[tmp_12],        %[tmp_12],    7                 \n\t"
        "lw               %[tmp_17],        32(%[mb])                       \n\t"
        "precrqu_s.qb.ph  %[tmp_10],        %[tmp_10],    %[tmp_10]         \n\t"
        "precrqu_s.qb.ph  %[tmp_12],        %[tmp_12],    %[tmp_12]         \n\t"
        "ulw              %[tmp_9],         0(%[tmp_pok])                   \n\t"
        "preceu.ph.qbr    %[tmp_10],        %[tmp_10]                       \n\t"
        "preceu.ph.qbr    %[tmp_12],        %[tmp_12]                       \n\t"
        "addq.ph          %[tmp_10],        %[tmp_10],    %[tmp_16]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_12],    %[tmp_6]          \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    1                 \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    1                 \n\t"
        "preceu.ph.qbr    %[tmp_6],         %[tmp_9]                        \n\t"
        "preceu.ph.qbl    %[tmp_16],        %[tmp_9]                        \n\t"
        "precr.qb.ph      %[tmp_10],        %[tmp_10],    %[tmp_12]         \n\t"
        "addq.ph          %[tmp_9],         %[tmp_5],     %[tmp_4]          \n\t"
        "sw               %[tmp_10],        48(%[mb])                       \n\t"
        "addq.ph          %[tmp_10],        %[tmp_1],     %[tmp_3]          \n\t"
        "mul.ph           %[tmp_9],         %[tmp_9],     %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_10],        %[tmp_10],    %[tmp_const_20]   \n\t"
        "addq.ph          %[tmp_11],        %[tmp_15],    %[tmp_14]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_7],     %[tmp_13]         \n\t"
        "mul.ph           %[tmp_11],        %[tmp_11],    %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_12],        %[tmp_12],    %[tmp_const_20]   \n\t"
        "subu             %[tmp_pok],       %[tmp_pok],   %[width]          \n\t"
        "subq.ph          %[tmp_9],         %[tmp_10],    %[tmp_9]          \n\t"
        "addq.ph          %[tmp_8],         %[tmp_8],     %[tmp_16]         \n\t"
        "addq.ph          %[tmp_2],         %[tmp_2],     %[tmp_6]          \n\t"
        "subq.ph          %[tmp_11],        %[tmp_12],    %[tmp_11]         \n\t"
        "addq.ph          %[tmp_10],        %[tmp_8],     %[tmp_11]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_2],     %[tmp_9]          \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    5                 \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    5                 \n\t"
        "ulw              %[tmp_11],        0(%[tmp_pok])                   \n\t"
        "shll_s.ph        %[tmp_10],        %[tmp_10],    7                 \n\t"
        ...
        "precrqu_s.qb.ph  %[tmp_10],        %[tmp_10],    %[tmp_10]         \n\t"
        "precrqu_s.qb.ph  %[tmp_12],        %[tmp_12],    %[tmp_12]         \n\t"
        "preceu.ph.qbr    %[tmp_2],         %[tmp_11]                       \n\t"
        "preceu.ph.qbr    %[tmp_10],        %[tmp_10]                       \n\t"
        "preceu.ph.qbr    %[tmp_9],         %[tmp_17]                       \n\t"
        "preceu.ph.qbl    %[tmp_17],        %[tmp_17]                       \n\t"
        "preceu.ph.qbr    %[tmp_12],        %[tmp_12]                       \n\t"
        "addq.ph          %[tmp_10],        %[tmp_10],    %[tmp_17]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_12],    %[tmp_9]          \n\t"
        "lw               %[tmp_17],        16(%[mb])                       \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    1                 \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    1                 \n\t"
        "precr.qb.ph      %[tmp_10],        %[tmp_10],    %[tmp_12]         \n\t"
        "preceu.ph.qbl    %[tmp_8],         %[tmp_11]                       \n\t"
        "addq.ph          %[tmp_9],         %[tmp_6],     %[tmp_3]          \n\t"
        "sw               %[tmp_10],        32(%[mb])                       \n\t"
        "addq.ph          %[tmp_10],        %[tmp_1],     %[tmp_5]          \n\t"
        "addq.ph          %[tmp_11],        %[tmp_16],    %[tmp_13]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_7],     %[tmp_15]         \n\t"
        "mul.ph           %[tmp_9],         %[tmp_9],     %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_10],        %[tmp_10],    %[tmp_const_20]   \n\t"
        "mul.ph           %[tmp_11],        %[tmp_11],    %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_12],        %[tmp_12],    %[tmp_const_20]   \n\t"
        "subu             %[tmp_pok],       %[tmp_pok],   %[width]          \n\t"
        "addq.ph          %[tmp_4],         %[tmp_4],     %[tmp_2]          \n\t"
        "addq.ph          %[tmp_14],        %[tmp_14],    %[tmp_8]          \n\t"
        "subq.ph          %[tmp_9],         %[tmp_10],    %[tmp_9]          \n\t"
        "subq.ph          %[tmp_11],        %[tmp_12],    %[tmp_11]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_4],     %[tmp_9]          \n\t"
        "addq.ph          %[tmp_10],        %[tmp_14],    %[tmp_11]         \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    5                 \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    5                 \n\t"
        "ulw              %[tmp_14],        0(%[tmp_pok])                   \n\t"
        "shll_s.ph        %[tmp_12],        %[tmp_12],    7                 \n\t"
        "shll_s.ph        %[tmp_10],        %[tmp_10],    7                 \n\t"
        "addiu            %[mb],            %[mb],        4                 \n\t"
        "precrqu_s.qb.ph  %[tmp_12],        %[tmp_12],    %[tmp_12]         \n\t"
        ...
        "shra_r.ph        %[tmp_12],        %[tmp_12],    1                 \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    1                 \n\t"
        "addq.ph          %[tmp_9],         %[tmp_2],     %[tmp_1]          \n\t"
        "precr.qb.ph      %[tmp_2],         %[tmp_10],    %[tmp_12]         \n\t"
        "addq.ph          %[tmp_10],        %[tmp_5],     %[tmp_6]          \n\t"
        "addq.ph          %[tmp_11],        %[tmp_8],     %[tmp_7]          \n\t"
        "addq.ph          %[tmp_12],        %[tmp_15],    %[tmp_16]         \n\t"
        "mul.ph           %[tmp_9],         %[tmp_9],     %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_10],        %[tmp_10],    %[tmp_const_20]   \n\t"
        "mul.ph           %[tmp_11],        %[tmp_11],    %[tmp_const_5]    \n\t"
        "mul.ph           %[tmp_12],        %[tmp_12],    %[tmp_const_20]   \n\t"
        "preceu.ph.qbr    %[tmp_4],         %[tmp_14]                       \n\t"
        "preceu.ph.qbl    %[tmp_14],        %[tmp_14]                       \n\t"
        "addq.ph          %[tmp_3],         %[tmp_3],     %[tmp_4]          \n\t"
        "addq.ph          %[tmp_13],        %[tmp_13],    %[tmp_14]         \n\t"
        "subq.ph          %[tmp_9],         %[tmp_10],    %[tmp_9]          \n\t"
        "subq.ph          %[tmp_11],        %[tmp_12],    %[tmp_11]         \n\t"
        "addq.ph          %[tmp_12],        %[tmp_3],     %[tmp_9]          \n\t"
        "addq.ph          %[tmp_10],        %[tmp_13],    %[tmp_11]         \n\t"
        "shra_r.ph        %[tmp_12],        %[tmp_12],    5                 \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    5                 \n\t"
        "sw               %[tmp_2],         12(%[mb])                       \n\t"
        "shll_s.ph        %[tmp_12],        %[tmp_12],    7                 \n\t"
        ...
        "shra_r.ph        %[tmp_12],        %[tmp_12],    1                 \n\t"
        "shra_r.ph        %[tmp_10],        %[tmp_10],    1                 \n\t"
        "precr.qb.ph      %[tmp_9],         %[tmp_10],    %[tmp_12]         \n\t"
        "sll              %[tmp_11],        %[width],     2                 \n\t"
        "addu             %[tmp_11],        %[tmp_11],    %[width]          \n\t"
        "addu             %[tmp_11],        %[tmp_11],    %[width]          \n\t"
        "addu             %[tmp_pok],       %[tmp_pok],   %[tmp_11]         \n\t"
        "sw               %[tmp_9], -4(%[mb])                               \n\t"
        "addiu            %[temp_partWidth],%[temp_partWidth],    -4        \n\t"
        "bnez             %[temp_partWidth],4b                              \n\t"
        " addiu           %[tmp_pok],       %[tmp_pok],   4                 \n\t"
        "sll              %[tmp_11],        %[width],     2                 \n\t"
        "addu             %[tmp_pok],       %[tmp_11],    %[tmp_pok]        \n\t"
        "addiu            %[mb],            %[mb],        64                \n\t"
        "subu             %[tmp_pok],       %[tmp_pok],   %[partWidth]      \n\t"
        "addiu            %[partHeight],    %[partHeight],-1                \n\t"
        "bnez             %[partHeight],    3b                              \n\t"
        " subu            %[mb],            %[mb],        %[partWidth]      \n\t"
        ".set pop                                                           \n\t"
        ...
        : [tmp_1] "=&r" (tmp_1), [tmp_2] "=&r" (tmp_2),
          ...
          [tmp_7] "=&r" (tmp_7), [tmp_8] "=&r" (tmp_8),
          [tmp_13] "=&r" (tmp_13), [tmp_14] "=&r" (tmp_14),
          [tmp_15] "=&r" (tmp_15), [tmp_16] "=&r" (tmp_16),
          [tmp_10] "=&r" (tmp_10), [tmp_9] "=&r" (tmp_9),
          [tmp_11] "=&r" (tmp_11), [tmp_12] "=&r" (tmp_12),
          [tmp_17] "=&r" (tmp_17),
          [mb] "+r" (mb), [temp_partWidth] "=&r" (temp_partWidth),
          [tmp_const_5] "=&r" (tmp_const_5), [tmp_const_20] "=&r" (tmp_const_20)
        : [width] "r" (width),[partWidth] "r" (partWidth),[partHeight] "r" (partHeight),
          [tmp_pok] "r" (tmp_pok)
        : "hi", "lo", "memory"
    );
}
  ...
  u32 verOffset)    /* 0 for pixel f, 1 for pixel q */
{
    ...
    if (!verOffset){
        ...
        {
           {
                i16 *pp1 = ptrC + 7*partWidth;
                /* prefetch for load for the whole next loop that follows */

                __asm__ volatile (
                    "pref       0,      0(%[pp1])                     \n\t"
                    "addu       %[pp1], %[pp1],      %[partWidth]     \n\t"
                    "pref       0,      0(%[pp1])                     \n\t"
                    "addu       %[pp1], %[pp1],      %[partWidth]     \n\t"
                    "pref       0,      0(%[pp1])                     \n\t"
                    "addu       %[pp1], %[pp1],      %[partWidth]     \n\t"
