...
/**
 * Helper function, initializes a lookup table to speed up the CRC-32 calculation.
 */
...
/**
 * Helper function, calculates a CRC-32 checksum incrementally using the same polynomial
 * as the cksum command.
 */
...
/**
 * Helper function, checks if the file conversion is alright. returns boolean status of conversion.
 */
...
/**
 * Helper function, creates empty forward lock content file.
 */
...
/**
 * Helper function, closes the file descripter if valid
 */
...
/**
 * Helper function, check if file physically exists.
 */
...
/**
 * TC - Normal FwdLock conversion with opening the file.
 */
...
/**
 * TC - NULL parameter test for openSession (filename as NULL)
 */
...
/**
 * TC - NULL parameter test for openSession (output as NULL)
 */
...
/**
 * TC - NULL parameter test for convertData (all NULL except output)
 */
...
/**
 * TC - NULL parameter test for convertData (output as NULL)
 */
...
/**
 * TC - NULL parameter test for ConvertOpenFile (intput/output descripter and readfunc NULL)
 */
...
/**
 * TC - NULL parameter test for ConvertOpenFile (intput/output descripter and writefunc NULL)
 */
...
/**
 * TC - NULL parameter test for ConvertOpenFile (intput/output descripter and lseekfunc NULL)
 */
...
/**
 * TC - NULL parameter test for ConvertFile (intput filname NULL with empty output filename)
 */
...
/**
 * TC - NULL parameter test for ConvertFile (output filname NULL with empty input filename)
 */
...
/**
 * TC - test for ConvertData for invalid session ID
 */
...
/**
 * TC - test for CloseSession for invalid session ID
 */
...
/**
 * TC - NULL parameter test for ConvertFile (empty input filename, NULL Output value)
 */
...
/**
 * TC - NULL parameter test for ConvertFile (Empty output filename, NULL output value)
 */
...
/**
 * Helper function, reads with always failed result.
 */
...
/**
 * TC - test ConvertOpenFile with always failing read function instead of normal read
 */
...
/**
 * Helper function, write with always failed result.
 */
...
/**
 * TC - test ConvertOpenFile with always failing write function instead of normal write
 */
...
/**
 * Helper function, lseek with always failed result.
 */
...
/**
 * TC - test ConvertOpenFile with always failing lseek function instead of normal lseek
 */
...
/**
 * TC - test ConvertOpenFile with file having empty data portion
 */
...
/**
 * TC - boundary test for ConvertOpenFile with too many session opened
 */
...
/**
 * Helper function for testing conversion with invalid given encoding type as input to converter
 */
...
/**
 * TC - test conversion with many different invalid encoding types.
 */
...
/**
 * TC - test conversion with binary encoding
 */
...
/**
 * TC - test conversion with base64 encoding
 */
...
/**
 * TC - test conversion with 7bit encoding
 */
...
/**
 * TC - test conversion with 8bit encoding
 */
...
/**
 * TC - test conversion for a Combined Delivery file (unsupported)
 */
...
/**
 * TC - test conversion for a Separate Delivery file (unsupported)
 */
...
/**
 * TC - test conversion for a file having some preamble data (extra data before actual data)
 */
...
/**
 * TC - test conversion for a file having whitespace after boundary characters
 */
...
/**
 * TC - test conversion for a very long boundary value
 */
...
/**
 * TC - test conversion for delimiter truncated
 */
...
/**
 * TC - test conversion with false match before delimiter
 */
...
/**
 * TC - test conversion with whitespaces inside the data
 */
...
/**
 * TC - test conversion with junk characters after padding
 */
...
/**
 * TC - test FwdLockFile_open with non existing file
 */
...
/**
 * TC - test FwdLockFile_open NULL input parameter
 */
...
/**
 * TC - test decoding of an empty data converted forward lock file.
 */
...
/**
 * TC - test FwdLockFile_attach with invalid file descripter as input parameter
 */
...
/**
 * TC - test FwdLockFile_read with invalid input parameters
 */
...
/**
 * TC - test FwdLockFile_lseek with invalid input parameters
 */
...
/**
 * TC - test FwdLockFile_detach with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_close with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_CheckDataIntegrity with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_CheckHeaderIntegrity with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_CheckIntegrity with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_GetContentType with invalid input parameter (file descripter)
 */
...
/**
 * TC - test FwdLockFile_lseek with empty converted data and no lseek is done.
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset using begining of file
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset from current position
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset from file end
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset with smaller value from beginning of file.
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset with smaller value using current position
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid offset with smaller value using file end position
 */
...
/**
 * TC - test decoding of FwdLock file with Invalid whence parameter.
 */
TEST_F(FwdLockTest, DecoderWhiteBoxInvalidOrigin) {
    SetInvalidFilePos(0, -1);
}
/**
 * TC - test decoder with multiple sessions by opening too many files.
 */
...
/**
 * Helper function, manipulates the file integrity so integrity check may/mayn't fail.
 */
...
/**
 * TC - Checking integrity by manipulating content type length position as maximum value.
 */
...
/**
 * TC - Checking integrity by manipulating content type length position as 0.
 */
...
/**
 * TC - Checking integrity by manipulating content type position as 0.
 */
...
/**
 * TC - Checking integrity by manipulating header data
 */
